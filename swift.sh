...
if [[ "$host_temp" = "controller" && "$all_in_one" = "nao" ]]; then
...
if [[ "$host_temp" = "object"  && "$all_in_one" = "nao" || ( "$computeObject" = "sim" && "$host_temp" = "compute"  && "$all_in_one" = "nao" ) ]]; then
...
# reiniciando os servicos swift
echo "Reiniciando serviços do swift..."
