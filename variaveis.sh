...
# controller, compute1, block1,object1
host=""

# se for utilizar all-in-one no controller
...
#use o comando 'lsblk' para verificar os discos disponíveis
disk_block=""
...
# de preferencia, usar o dalmatian, epoxy e bobcat (22.04)
...
interface_ger="" # interface de gerenciamento

# insira as 3 primeiras partes do ip da sua rede de gerenciamento
ip_ger=""

# verifica se a variável 'ip_ger' estiver vazia
if [[ -z "$ip_ger" ]]; then
ip_ger="$ip_internet"
fi
