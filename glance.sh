...
sudo qemu-img convert -O raw noble-server-cloudimg-amd64.img noble-server-cloudimg-amd64.raw
#sudo qemu-img convert -O raw focal-server-cloudimg-amd64.img focal-server-cloudimg-amd64.raw
#sudo qemu-img convert -O raw jammy-server-cloudimg-amd64.img jammy-server-cloudimg-amd64.raw

glance image-create --name "cirros" --file cirros-0.4.0-x86_64-disk.img --disk-format qcow2 --container-format bare --visibility=public
glance image-create --name "Ubuntu Server 24" --file noble-server-cloudimg-amd64.raw --disk-format raw --container-format bare --visibility=public
#glance image-create --name "Ubuntu Server 22" --file jammy-server-cloudimg-amd64.raw --disk-format raw --container-format bare --visibility=public
#glance image-create --name "Ubuntu Server 20" --file focal-server-cloudimg-amd64.raw --disk-format raw --container-format bare --visibility=public
